...
exports.app = app;
},{}],"src/views/Login.js":[function(require,module,exports) {
"use strict";
...
var Login = function Login(state) {
  return (0, _hyperapp.h)("div", null, (0, _hyperapp.h)("div", {
    ...
    name: "Login"
  }, (0, _hyperapp.h)("div", null, password, username), (0, _hyperapp.h)("div", null, (0, _hyperapp.h)("input", {
    type: "text",
    name: "username",
    label: "Username"
  })), (0, _hyperapp.h)("div", null, (0, _hyperapp.h)("input", {
    type: "password",
    name: "password",
    label: "Password"
  })), (0, _hyperapp.h)("div", null, (0, _hyperapp.h)("button", {
    type: "submit",
    value: "Login"
  }, "Login")))));
};
...
exports.Login = Login;
},{"hyperapp":"node_modules/hyperapp/src/index.js"}],"src/state.js":[function(require,module,exports) {
"use strict";
...
},{"./views/Login":"src/views/Login.js"}],"src/actions.js":[function(require,module,exports) {
"use strict";
...
var SetRoute = function SetRoute(state, route) {
...
var Route = function () {
  var _get = function get(dispatch, action) {
    return dispatch(action, window.location.hash || '#');
  };

  var _sub = function sub(dispatch, action) {
    var handler = function handler() {
      return _get(dispatch, action);
    };
...
var Routes = {
  "#home": {
    ...
    view: function view(state) {
      return (0, _hyperapp.h)("div", null, "home");
    }
  }
};
exports.Routes = Routes;
},{"hyperapp":"node_modules/hyperapp/src/index.js"}],"src/App.js":[function(require,module,exports) {
"use strict";
...
var _default = (0, _hyperapp.app)({
  init: _state.defaultState,
  node: document.getElementById("app"),
  view: function view(state) {
    return (0, _hyperapp.h)("div", null, _Router.Routes[state.route].view(state));
  },
  subscriptions: function subscriptions(state) {
    return [_Router.Route.sub(_actions.SetRoute)];
  }
});

exports.default = _default;
},{"hyperapp":"node_modules/hyperapp/src/index.js","./state.js":"src/state.js","./actions":"src/actions.js","./Router":"src/Router.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
